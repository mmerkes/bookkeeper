...
describe('UNIT Model', function () {
  describe('constructor', function () {
    it('should set _fields and _properties to input', function () {
      var fields = {
        id: {
          type: 'int'
        },
    ...
    it('should throw if a field has no type', function () {
      var fields = {
        id: {
          type: 'int'
        },
    ...
    it('should throw if a field does not have a valid type', function () {
      var fields = {
        id: {
          type: 'foo'
        },
    ...
    it('should throw if primary_key is not defined in fields', function () {
      var fields = {
        id: {
          type: 'int'
        },
    ...
    it('should throw if foreign_key is invalid', function () {
      var fields = {
        id: {
          type: 'int'
        },
